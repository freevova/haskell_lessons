...
meanTsAll :: Maybe Double
meanTsAll = meanTS tsAll
...
a = makeTSCompare max (3,Just 200) (4,Just 10)
...
minTsAll :: Maybe (Int, Maybe Double)
minTsAll = minTS tsAll
maxTs1 :: Maybe (Int, Maybe Double)
maxTs1 = maxTS ts1
